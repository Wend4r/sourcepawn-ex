...
static const char* errmsg[] = {
    ...
    /*035*/ "argument type mismatch (expected \"%s\", got \"%s\", argument %d)\n",
    /*036*/ "empty statement\n",
    ...
    /*065*/ "enum struct fields cannot have more than two dimension\n",
    ...
    /*070*/ "directive \"%s\" available only with the parameter \"%s\"\n",
